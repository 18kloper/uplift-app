    ...
    <div style={{ background: SOFT, minHeight: "100vh",
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "18px 20px 80px" }}>
        ...
        <Section id="guide">
          ...
          <Label>FAQ</Label>
          <FAQ items={[
            { q: "What are my program responsibilities?", a: "Your core commitments: ① Complete 3 sessions (60 min each) with your mentee by August 4. ② Attend the Midpoint Meetup (July, date TBD) and the Uplift Summit (August). ③ Complete the End of Program Sign-Off — this is required and generates your mentor certificate. ④ Maintain reasonable communication with your mentee — respond to messages within a few days." },
