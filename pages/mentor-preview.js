...
const COHORT = {
  ...
  funFacts: [
    ...
    { emoji: "🗓️", stat: "286",  label: "total mentor hours this summer", tip: "If every mentor completes all 3 sessions (76 founders × 3.76 hrs avg) — 286 hours of mentorship this summer.", rainbow: false },
    { emoji: "⭐", stat: "5",    label: "returning mentors",              tip: "5 mentors are back for another summer — returning because they believed in Uplift enough to do it again.", rainbow: false },
    { emoji: "📈", stat: "70%", label: "of mentored businesses survive 5+ yrs", tip: "70% of mentored businesses survive 5+ years — compared to just 35% without a mentor.\n\nMentored founders also raise 7x more funding on average.\n\nSource: SBA / SCORE mentorship research.", rainbow: false },
