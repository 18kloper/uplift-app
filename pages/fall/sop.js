...
const ADMIN_TABS = [
  ...
  ["Matching", "Scored mentor suggestions per founder. You make the call, it shows its reasoning."],
...
const RUNBOOK = [
  ...
  ["Make a match", "Admin → Matching. Scores are a transparent heuristic, weighted heaviest on session commitment. You decide; unmatching preserves history."],
