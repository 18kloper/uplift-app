...
// Body: { slug, name, title, url }
// Appends one row to the EventClicks sheet tab — fire-and-forget from the portal.
...
async function ensureTab(sheets, spreadsheetId) {
  try {
    ...
    await sheets.spreadsheets.values.update({
      ...
      requestBody: { values: [["Timestamp", "Slug", "Name", "Event", "URL"]] },
    });
              ...
              repeatCell: {
                ...
                cell: {
                  userEnteredFormat: {
                    ...
                    backgroundColor: { red: 0.16, green: 0.44, blue: 0.83 },
                  },
                },
    ...
    console.error("ensureEventClicksTab failed:", err.message);
  }
}
